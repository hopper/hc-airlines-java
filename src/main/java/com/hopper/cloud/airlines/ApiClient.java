...
import com.hopper.cloud.airlines.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private String basePath = "http://localhost/airline/v1.0";
    ...
    public ApiClient() {
        ...
        authentications.put("PartnerAuth", new OAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost/airline/v1.0
