...
import com.hopper.cloud.airlines.auth.Authentication;
import com.hopper.cloud.airlines.auth.HttpBasicAuth;
import com.hopper.cloud.airlines.auth.HttpBearerAuth;
import com.hopper.cloud.airlines.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://airlines-api.hopper.com/airline/v1.1";
    ...
    public ApiClient() {
        ...
        authentications.put("PartnerAuth", new HttpBearerAuth("bearer"));
        authentications.put("SessionAuth", new ApiKeyAuth("header", "HC-Session-ID"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://airlines-api.hopper.com/airline/v1.1
     ...
     * @return a {@link com.hopper.cloud.airlines.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.hopper.cloud.airlines.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.hopper.cloud.airlines.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.hopper.cloud.airlines.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.hopper.cloud.airlines.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.hopper.cloud.airlines.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.hopper.cloud.airlines.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.hopper.cloud.airlines.ApiException If fails to update the parameters
     */
