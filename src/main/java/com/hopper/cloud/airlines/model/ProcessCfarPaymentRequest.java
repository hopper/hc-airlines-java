...
public class ProcessCfarPaymentRequest {
  ...
  public ProcessCfarPaymentRequest addressLine1(@javax.annotation.Nullable String addressLine1) {
  ...
  public ProcessCfarPaymentRequest addressLine2(@javax.annotation.Nullable String addressLine2) {
  ...
  public ProcessCfarPaymentRequest city(@javax.annotation.Nullable String city) {
    this.city = city;
    return this;
  }
  ...
  public ProcessCfarPaymentRequest stateOrProvince(@javax.annotation.Nullable String stateOrProvince) {
  ...
  public ProcessCfarPaymentRequest postalCode(@javax.annotation.Nullable String postalCode) {
  ...
  public ProcessCfarPaymentRequest country(@javax.annotation.Nullable String country) {
  ...
  public boolean equals(Object o) {
    ...
    ProcessCfarPaymentRequest processCfarPaymentRequest = (ProcessCfarPaymentRequest) o;
    return Objects.equals(this.paymentMethodToken, processCfarPaymentRequest.paymentMethodToken) &&
        Objects.equals(this.firstName, processCfarPaymentRequest.firstName) &&
        Objects.equals(this.lastName, processCfarPaymentRequest.lastName) &&
        Objects.equals(this.addressLine1, processCfarPaymentRequest.addressLine1) &&
        Objects.equals(this.addressLine2, processCfarPaymentRequest.addressLine2) &&
        Objects.equals(this.city, processCfarPaymentRequest.city) &&
        Objects.equals(this.stateOrProvince, processCfarPaymentRequest.stateOrProvince) &&
        Objects.equals(this.postalCode, processCfarPaymentRequest.postalCode) &&
        Objects.equals(this.country, processCfarPaymentRequest.country) &&
        Objects.equals(this.pnrReference, processCfarPaymentRequest.pnrReference) &&
        Objects.equals(this.emailAddress, processCfarPaymentRequest.emailAddress);
  }

  @Override
  public int hashCode() {
    return Objects.hash(paymentMethodToken, firstName, lastName, addressLine1, addressLine2, city, stateOrProvince, postalCode, country, pnrReference, emailAddress);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("payment_method_token");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProcessCfarPaymentRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProcessCfarPaymentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProcessCfarPaymentRequest is not found in the empty JSON string", ProcessCfarPaymentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProcessCfarPaymentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProcessCfarPaymentRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProcessCfarPaymentRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("payment_method_token").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProcessCfarPaymentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProcessCfarPaymentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProcessCfarPaymentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProcessCfarPaymentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ProcessCfarPaymentRequest>() {
           @Override
           public void write(JsonWriter out, ProcessCfarPaymentRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProcessCfarPaymentRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProcessCfarPaymentRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProcessCfarPaymentRequest
   * @throws IOException if the JSON string is invalid with respect to ProcessCfarPaymentRequest
   */
  public static ProcessCfarPaymentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProcessCfarPaymentRequest.class);
  }

  /**
   * Convert an instance of ProcessCfarPaymentRequest to an JSON string
   *
   * @return JSON string
   */
