...
import com.hopper.cloud.airlines.model.DgAncillary;
...
public class DgItinerary {
  ...
  public DgItinerary addPassengerPricingItem(DgPassengerPricing passengerPricingItem) {
  ...
  public DgItinerary addSlicesItem(DgItinerarySlice slicesItem) {
    if (this.slices == null) {
  ...
  public DgItinerary ancillaries(@javax.annotation.Nullable List<DgAncillary> ancillaries) {
    this.ancillaries = ancillaries;
    return this;
  }

  public DgItinerary addAncillariesItem(DgAncillary ancillariesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<DgAncillary> getAncillaries() {
    return ancillaries;
  }

  public void setAncillaries(@javax.annotation.Nullable List<DgAncillary> ancillaries) {
    this.ancillaries = ancillaries;
  }


  public DgItinerary totalPrice(@javax.annotation.Nullable String totalPrice) {
  ...
  public DgItinerary passengers(@javax.annotation.Nullable List<DgPassenger> passengers) {
    this.passengers = passengers;
    return this;
  }

  public DgItinerary addPassengersItem(DgPassenger passengersItem) {
  ...
  public boolean equals(Object o) {
    ...
    DgItinerary dgItinerary = (DgItinerary) o;
    return Objects.equals(this.passengerPricing, dgItinerary.passengerPricing) &&
        Objects.equals(this.currency, dgItinerary.currency) &&
        Objects.equals(this.slices, dgItinerary.slices) &&
        Objects.equals(this.ancillaries, dgItinerary.ancillaries) &&
        Objects.equals(this.totalPrice, dgItinerary.totalPrice) &&
        Objects.equals(this.passengers, dgItinerary.passengers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(passengerPricing, currency, slices, ancillaries, totalPrice, passengers);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DgItinerary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DgItinerary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DgItinerary is not found in the empty JSON string", DgItinerary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DgItinerary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DgItinerary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DgItinerary.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayslices.size(); i++) {
        DgItinerarySlice.validateJsonElement(jsonArrayslices.get(i));
      };
      if (jsonObj.get("ancillaries") != null && !jsonObj.get("ancillaries").isJsonNull()) {
        ...
        if (jsonArrayancillaries != null) {
          ...
          for (int i = 0; i < jsonArrayancillaries.size(); i++) {
            DgAncillary.validateJsonElement(jsonArrayancillaries.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DgItinerary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DgItinerary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DgItinerary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DgItinerary.class));

       return (TypeAdapter<T>) new TypeAdapter<DgItinerary>() {
           @Override
           public void write(JsonWriter out, DgItinerary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DgItinerary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DgItinerary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DgItinerary
   * @throws IOException if the JSON string is invalid with respect to DgItinerary
   */
  public static DgItinerary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DgItinerary.class);
  }

  /**
   * Convert an instance of DgItinerary to an JSON string
   *
   * @return JSON string
   */
