...
public class DgOffer {
  ...
  public DgOffer premium(String premium) {
  ...
  public DgOffer coverage(String coverage) {
  ...
  public DgOffer coveragePercentage(String coveragePercentage) {
  ...
  public DgOffer serviceCap(String serviceCap) {
  ...
  public DgOffer currency(String currency) {
  ...
  public DgOffer taxesTotal(String taxesTotal) {
  ...
  public DgOffer requestType(DgRequestType requestType) {
  ...
  public DgOffer maxHoursBeforeDeparture(Integer maxHoursBeforeDeparture) {
  ...
  public DgOffer minMinutesDelay(Integer minMinutesDelay) {
  ...
  public DgOffer contractExpiryDateTime(OffsetDateTime contractExpiryDateTime) {
  ...
  public DgOffer createdDateTime(OffsetDateTime createdDateTime) {
  ...
  public DgOffer itinerary(DgItinerary itinerary) {
  ...
  public DgOffer extAttributes(Map<String, String> extAttributes) {
  ...
  public DgOffer contents(Map<String, DgContents> contents) {
