...
public class DgContents {
  ...
  public DgContents bulletPoints(List<String> bulletPoints) {
  ...
  public DgContents labels(Map<String, String> labels) {
    this.labels = labels;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DgContents
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DgContents.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DgContents is not found in the empty JSON string", DgContents.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DgContents.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DgContents` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DgContents.openapiRequiredFields) {
