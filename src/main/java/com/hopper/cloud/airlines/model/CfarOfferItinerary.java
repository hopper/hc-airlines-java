...
public class CfarOfferItinerary {
  ...
  @javax.annotation.Nullable
  private List<CfarOfferPassenger> passengers = new ArrayList<>();
  ...
  public CfarOfferItinerary ancillaries(@javax.annotation.Nullable List<Ancillary> ancillaries) {
  ...
  public CfarOfferItinerary totalPrice(@javax.annotation.Nullable String totalPrice) {
  ...
  public CfarOfferItinerary passengers(@javax.annotation.Nullable List<CfarOfferPassenger> passengers) {
    this.passengers = passengers;
    return this;
  }

  public CfarOfferItinerary addPassengersItem(CfarOfferPassenger passengersItem) {
  ...
  public void setPassengers(@javax.annotation.Nullable List<CfarOfferPassenger> passengers) {
    this.passengers = passengers;
  }


  public CfarOfferItinerary fareRules(@javax.annotation.Nullable List<FareRule> fareRules) {
    this.fareRules = fareRules;
    return this;
  }

  public CfarOfferItinerary addFareRulesItem(FareRule fareRulesItem) {
  ...
  public boolean equals(Object o) {
    ...
    CfarOfferItinerary cfarOfferItinerary = (CfarOfferItinerary) o;
    return Objects.equals(this.passengerPricing, cfarOfferItinerary.passengerPricing) &&
        Objects.equals(this.currency, cfarOfferItinerary.currency) &&
        Objects.equals(this.slices, cfarOfferItinerary.slices) &&
        Objects.equals(this.ancillaries, cfarOfferItinerary.ancillaries) &&
        Objects.equals(this.totalPrice, cfarOfferItinerary.totalPrice) &&
        Objects.equals(this.passengers, cfarOfferItinerary.passengers) &&
        Objects.equals(this.fareRules, cfarOfferItinerary.fareRules);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CfarOfferItinerary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CfarOfferItinerary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CfarOfferItinerary is not found in the empty JSON string", CfarOfferItinerary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CfarOfferItinerary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CfarOfferItinerary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CfarOfferItinerary.openapiRequiredFields) {
      ...
      if (jsonObj.get("passengers") != null && !jsonObj.get("passengers").isJsonNull()) {
        ...
        if (jsonArraypassengers != null) {
          ...
          for (int i = 0; i < jsonArraypassengers.size(); i++) {
            CfarOfferPassenger.validateJsonElement(jsonArraypassengers.get(i));
          };
        }
      }
