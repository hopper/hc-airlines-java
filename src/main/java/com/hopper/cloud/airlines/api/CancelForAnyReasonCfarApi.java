...
import com.hopper.cloud.airlines.model.CreateExternalCfarOfferRequest;
import java.io.File;
...
public class CancelForAnyReasonCfarApi {
    ...
    /**
     * Build call for getCustomerCfarPayoutReceipt
     ...
     */
    public okhttp3.Call getCustomerCfarPayoutReceiptCall(String verificationCode, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/customer/cfar/payout/receipt";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getCustomerCfarPayoutReceiptValidateBeforeCall(String verificationCode, final ApiCallback _callback) throws ApiException {
        return getCustomerCfarPayoutReceiptCall(verificationCode, _callback);
     ...
     */
    public File getCustomerCfarPayoutReceipt(String verificationCode) throws ApiException {
        ApiResponse<File> localVarResp = getCustomerCfarPayoutReceiptWithHttpInfo(verificationCode);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<File> getCustomerCfarPayoutReceiptWithHttpInfo(String verificationCode) throws ApiException {
        okhttp3.Call localVarCall = getCustomerCfarPayoutReceiptValidateBeforeCall(verificationCode, null);
     ...
     */
    public okhttp3.Call getCustomerCfarPayoutReceiptAsync(String verificationCode, final ApiCallback<File> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCustomerCfarPayoutReceiptValidateBeforeCall(verificationCode, _callback);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for postCfarOffersExternal
     * @param createExternalCfarOfferRequest  (required)
     * @param hcSessionID The ID of the current airline session, see [Sessions](#tag/Sessions) (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> The created CFAR offer </td><td>  * Expires -  <br>  * Cache-Control -  <br>  * HTS-Session-ID - The ID of the current session, see [Sessions](#tag/Sessions) <br>  </td></tr>
        <tr><td> 400 </td><td> Syntactic errors were encountered while handling the request </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> The client could not be authenticated </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> The authenticated client does not have permission to call this endpoint </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> The requested resource could not be found </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call postCfarOffersExternalCall(CreateExternalCfarOfferRequest createExternalCfarOfferRequest, String hcSessionID, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = createExternalCfarOfferRequest;

        // create path and map variables
        String localVarPath = "/cfar_offers/external";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postCfarOffersExternalValidateBeforeCall(CreateExternalCfarOfferRequest createExternalCfarOfferRequest, String hcSessionID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'createExternalCfarOfferRequest' is set
        if (createExternalCfarOfferRequest == null) {
            throw new ApiException("Missing the required parameter 'createExternalCfarOfferRequest' when calling postCfarOffersExternal(Async)");
        }

        return postCfarOffersExternalCall(createExternalCfarOfferRequest, hcSessionID, _callback);
     ...
     */
    public CfarOffer postCfarOffersExternal(CreateExternalCfarOfferRequest createExternalCfarOfferRequest, String hcSessionID) throws ApiException {
        ApiResponse<CfarOffer> localVarResp = postCfarOffersExternalWithHttpInfo(createExternalCfarOfferRequest, hcSessionID);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CfarOffer> postCfarOffersExternalWithHttpInfo(CreateExternalCfarOfferRequest createExternalCfarOfferRequest, String hcSessionID) throws ApiException {
        okhttp3.Call localVarCall = postCfarOffersExternalValidateBeforeCall(createExternalCfarOfferRequest, hcSessionID, null);
        Type localVarReturnType = new TypeToken<CfarOffer>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create External CFAR Offer (asynchronously)
     * Create a CFAR offer with externally provided pricing and coverage details (temporal API for data migration)
     * @param createExternalCfarOfferRequest  (required)
     * @param hcSessionID The ID of the current airline session, see [Sessions](#tag/Sessions) (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call postCfarOffersExternalAsync(CreateExternalCfarOfferRequest createExternalCfarOfferRequest, String hcSessionID, final ApiCallback<CfarOffer> _callback) throws ApiException {

        okhttp3.Call localVarCall = postCfarOffersExternalValidateBeforeCall(createExternalCfarOfferRequest, hcSessionID, _callback);
        Type localVarReturnType = new TypeToken<CfarOffer>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
