...
public class ExampleApiClient extends CommonExampleApiClient {
    ...
    private static boolean processCfarPayment(CancelForAnyReasonCfarApi client, String contractId, String sessionId) throws ApiException {
        ...
        CfarPayment payment = client.postCfarContractsIdPayment(sessionId, processCfarPaymentRequest, contractId);
        return payment.getSucceeded();
    }
}